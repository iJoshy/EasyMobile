//
//  iPhoneMyAccountViewController.m
//  EasyMobile
//
...
@implementation iPhoneMyAccountViewController
{
...
-(void)processInitData
{
    ...
    if ([eventCode isEqualToString:@"-25"] )
    {
        ...
        //mirageCode = [mirageCode isKindOfClass:[NSNull class]] ? @"OOPS" : mirageCode;
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                __weak iPhoneMyAccountViewController *self_ = self;
...
{    
    ...
    [self performSegueWithIdentifier: @"BuyDataSegue" sender:self];
}
...
{
    [self performSegueWithIdentifier: @"RechargeOthersSegue" sender:self];
}


-(IBAction)rechargeTransferClicked:(id)sender
{
    [self performSegueWithIdentifier: @"RechargeTransferSegue" sender:self];
}
