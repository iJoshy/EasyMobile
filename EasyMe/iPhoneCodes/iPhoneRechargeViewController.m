//
//  iPhoneRechargeViewController.m
//  EasyMobile
//
...
#import "iPhoneRechargeViewController.h"


@implementation iPhoneRechargeViewController
{
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    else if ( rechargeCode.text.length == 15 )
    {
        ...
        __weak iPhoneRechargeViewController *self_ = self;
