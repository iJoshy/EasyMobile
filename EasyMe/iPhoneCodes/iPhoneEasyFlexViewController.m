//
//  iPhoneEasyFlexViewController.m
//  EasyMobile
//
...
#import "iPhoneEasyFlexViewController.h"

@implementation iPhoneEasyFlexViewController
{
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.tracker set:kGAIScreenName value:@"EasyFlex"];
    [self.tracker send:[[GAIDictionaryBuilder createScreenView] build]];
}


-(IBAction)easyflexBundleClicked:(id)sender
{
...
-(void)processEasyflexData
{
    ...
    if ([easyflexList isKindOfClass:[NSArray class]])
    {
        ...
        [self performSegueWithIdentifier: @"EasyFlexBundlesSegue" sender:self];
    }
    else
    {
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    if (btn.tag == 51)
    {
        actionPerformed = @"Easyflex Cancel";
    ...
    {
        actionPerformed = @"EasyFlex CheckStatus";
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                __weak iPhoneEasyFlexViewController *self_ = self;
