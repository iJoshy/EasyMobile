//
//  iPhoneRechargeTransferViewController.m
//  EasyMobile
//
...
#import "iPhoneRechargeTransferViewController.h"
#import "AppConstants.h"

@implementation iPhoneRechargeTransferViewController
{
        ...
        else
        {
            ...
            else
            {
                ...
                if ( securityCode.text.length == 4 && receiversNo.text.length == 11 )
                {
                    ...
                    __weak iPhoneRechargeTransferViewController *self_ = self;
