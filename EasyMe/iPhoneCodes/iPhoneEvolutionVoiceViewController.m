//
//  iPhoneEvolutionVoiceViewController.m
//  EasyMobile
//
...
#import "iPhoneEvolutionVoiceViewController.h"
#import "ShadowButton.h"


@implementation iPhoneEvolutionVoiceViewController
{
...
- (void)viewDidLoad
{
    ...
    NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:@"EASYFLEXEVOLUTIONVOICE"];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.tracker set:kGAIScreenName value:@"Easyflex Evolution Voice"];
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    __weak iPhoneEvolutionVoiceViewController *self_ = self;
    ...
    [ self.tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"Easyflex Evolution Voice"
                                                                action:@"touch"
...
-(void)actionTaken:(NSInteger)number
{
    ...
    if ([appuser isEqualToString:@"APPLE"])
    {
        ...
        [ps sendToServer:@"Easyflex Evolution Voice"];
    }
    else
    {
