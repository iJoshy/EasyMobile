//
//  iPhoneEasyBusinessViewController.m
//  EasyMobile
//
...
@implementation iPhoneEasyBusinessViewController
{
    AMSmoothAlertView *alert;
    AMSmoothAlertView *alertCool;
}

@synthesize easyBizList, jsonResponse, priceAr, codeAr;
...
- (void)viewDidLoad
{
    ...
    NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:@"EASYBIZDATA"];
    easyBizList = [NSKeyedUnarchiver unarchiveObjectWithData:data];
    
    NSArray * dataContent = [self easyBizList];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.tracker set:kGAIScreenName value:@"EasyBusiness Classic"];
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    __weak iPhoneEasyBusinessViewController *self_ = self;
    ...
    [ self.tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"Easybusiness Classic"
                                                                action:@"touch"
                                                                 label:[NSString stringWithFormat:@"Easybusiness  Classic %@ bundle",priceStr]
                                                                 value:nil] build]];
