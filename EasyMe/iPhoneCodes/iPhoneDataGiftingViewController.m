//
//  iPhoneDataGiftingViewController.m
//  EasyMobile
//
...
#import "iPhoneDataGiftingViewController.h"
#import "AppConstants.h"

@implementation iPhoneDataGiftingViewController
{
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    else if ( receiversNo.text.length == 11 )
    {
        ...
        __weak iPhoneDataGiftingViewController *self_ = self;
