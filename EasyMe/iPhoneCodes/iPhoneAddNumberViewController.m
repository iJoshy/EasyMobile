//
//  iPhoneAddNumberViewController.m
//  EasyMobile
//
...
#import "iPhoneAddNumberViewController.h"
#import "MFSideMenu.h"
#import "AppConstants.h"

@implementation iPhoneAddNumberViewController
{
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [tracker set:kGAIScreenName value:@"EasyStarter AddNo"];
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    else if ( number.text.length == 11 )
    {
        ...
        __weak iPhoneAddNumberViewController *self_ = self;
...
- (void)actionTaken
{
    ...
    if ([appuser isEqualToString:@"APPLE"])
    {
        ...
        [ps sendToServer:@"EasyStarter AddNo"];
    }
    else
    {
        jsonResponse  = nil;
        ...
        NSString *serviceControllerCode = @"ADD_YOU_AND_ME";
        NSString *txnAmount = @"0";
        NSString *serviceFlag = @"1";
        
        requestData = @{ @"versionNo":versionNo, @"originatingMsisdn":originatingMsisdn, @"osType":osType, @"destinationMsisdnOne":destinationMsisdnOne, @"serviceControllerCode":serviceControllerCode, @"txnAmount":txnAmount, @"serviceFlag":serviceFlag };
