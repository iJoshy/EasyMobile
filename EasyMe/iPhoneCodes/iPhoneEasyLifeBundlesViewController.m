//
//  iPhoneEasyLifeBundlesViewController.m
//  EasyMobile
//
...
@implementation iPhoneEasyLifeBundlesViewController
{
...
- (void)viewDidLoad
{
    ...
    NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:@"EASYLIFEDATA"];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.tracker set:kGAIScreenName value:@"EasyLife Bundles"];
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    __weak iPhoneEasyLifeBundlesViewController *self_ = self;
    ...
    [ self.tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"EasyLife"
                                                                action:@"touch"
                                                                 label:[NSString stringWithFormat:@"EasyLife %@ bundle",priceStr]
                                                                 value:nil] build]];
...
-(void)actionTaken:(NSInteger)number
{
    ...
    if ([appuser isEqualToString:@"APPLE"])
    {
        ...
        [ps sendToServer:@"EasyLife Bundles"];
    }
    else
    {
