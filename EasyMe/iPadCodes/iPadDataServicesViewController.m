//
//  iPadDataServicesViewController.m
//  EasyMobile
//
...
@implementation iPadDataServicesViewController
{
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    else if (btn.tag == 6)
    {
        ...
        __weak iPadDataServicesViewController *self_ = self;
...
{
    [self removeSelfView];
    [[NSUserDefaults standardUserDefaults] setObject:@"data" forKey:@"FROM"];
...
-(IBAction)dataTransferClicked:(id)sender
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ShowDataTransferView" object:nil userInfo:nil];
}
...
-(IBAction)dataGiftingClicked:(id)sender
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ShowDataGiftingView" object:nil userInfo:nil];
}
