...
@implementation iPadDataPlansViewController
{
...
- (void)didMoveToParentViewController:(UIViewController *)parent
{
    ...
    paymode = [[NSUserDefaults standardUserDefaults] objectForKey:@"PAYMENTMODE"];
    ...
    while ( i < lengthOfBundles )
    {
        ...
        if ( btncount % 2 == 0 )
        {
            ...
            button.frame = CGRectMake(20.0, (4.0 + (yLength * btncount)), 345.0, 125.0);
            button.backgroundColor = [UIColor colorWithRed:176.0/255.0 green:210.0/255.0 blue:0.0/255.0 alpha:1];
            button.tag = i;
           
            UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(35, 25, 240, 87)];
            [lbl setFont:[UIFont fontWithName:@"NeoTechAlt-Medium" size:25.0]];
            ...
            button2.frame = CGRectMake(370.0, (4.0 + (yLength * btncount)), 345.0, 125.0);
            button2.backgroundColor = [UIColor colorWithRed:92.0/255.0 green:147.0/255.0 blue:0.0/255.0 alpha:1];
            button2.tag = i;
            
            UILabel *lbl2 = [[UILabel alloc] initWithFrame:CGRectMake(35, 25, 240, 87)];
            [lbl2 setFont:[UIFont fontWithName:@"NeoTechAlt-Medium" size:25.0]];
        ...
        else
        {
            ...
            button3.frame = CGRectMake(20.0, (4.0 + (yLength * btncount)), 695.0, 125.0);
            button3.backgroundColor = [UIColor colorWithRed:38.0/255.0 green:47.0/255.0 blue:56.0/255.0 alpha:1];
            button3.tag = i;
            
            UILabel *lbl3 = [[UILabel alloc] initWithFrame:CGRectMake(235, 17, 240, 87)];
            [lbl3 setFont:[UIFont fontWithName:@"NeoTechAlt-Medium" size:25.0]];
...
-(IBAction)clickedBtn:(id)sender
{
    ...
    if ([paymode isEqualToString:@"0"])
    {
        ...
        __weak iPadDataPlansViewController *self_ = self;
